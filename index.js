...
MongoClient.connect(process.env.MONGODB_URI_POS_V2, {
    ...
    .then(async client => {
        ...
        // Notifications Routes (proxy to Consumer API)
        ...
        // Recommendations Routes (proxy to Consumer API)
        const recommendationsRouter = require('./src/routes/v1/recommendations')(db);
